...
dwp_dI4 = (1.0e0_dp/2.0e0_dp)*(-I4*I6 + 2*I5**2)/(I4**2*sqrt(I4*I6 - I5**2))
...
d2wp_dI42 = (1.0e0_dp/4.0e0_dp)*(-I4**2*I6**2 - 4*I4*I6*(I4*I6 - I5**2) + 8*( &
      I4*I6 - I5**2)**2)/(I4**3*(I4*I6 - I5**2)**(3.0e0_dp/2.0e0_dp))
...
d2wp_dI4dI5 = (1.0e0_dp/2.0e0_dp)*I5*(3*I4*I6 - 2*I5**2)/(I4**2*(I4*I6 - I5**2 &
      )**(3.0e0_dp/2.0e0_dp))
...
d2wp_dI4dI6 = -1.0e0_dp/4.0e0_dp*I6/(I4*I6 - I5**2)**(3.0e0_dp/2.0e0_dp)
...
d2wp_dI52 = -I6/(I4*I6 - I5**2)**(3.0e0_dp/2.0e0_dp)
...
d2wp_dI5dI6 = (1.0e0_dp/2.0e0_dp)*I5/(I4*I6 - I5**2)**(3.0e0_dp/2.0e0_dp)
...
dwp_dI6 = (1.0e0_dp/2.0e0_dp)/sqrt(I4*I6 - I5**2)
...
d2wp_dI62 = -1.0e0_dp/4.0e0_dp*I4/(I4*I6 - I5**2)**(3.0e0_dp/2.0e0_dp)

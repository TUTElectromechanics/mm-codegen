...
REAL(KIND=dp) function dphi_dBx(dI4_dBx, dI5_dBx, du_dup, dup_dI4, dv_dvp, dvp_dI4, &
...
REAL(KIND=dp) function d2phi_dBx2(d2I4_dBx2, d2I5_dBx2, d2up_dI42, d2vp_dI42, &
...
REAL(KIND=dp) function d2phi_dBxdBy(d2I5_dBxdBy, d2up_dI42, d2vp_dI42, d2vp_dI4dI5, &
...
REAL(KIND=dp) function d2phi_dBxdBz(d2I5_dBxdBz, d2up_dI42, d2vp_dI42, d2vp_dI4dI5, &
...
REAL(KIND=dp) function d2phi_dBxdepsxx(d2I5_dBxdexx, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBxdepsxy(d2I5_dBxdexy, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBxdepsyy(d2I5_dBxdexx, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBxdepsyz(d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, dI4_dBx, &
...
REAL(KIND=dp) function d2phi_dBxdepszx(d2I5_dBxdezx, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBxdepszz(d2I5_dBxdexx, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function dphi_dBy(dI4_dBy, dI5_dBy, du_dup, dup_dI4, dv_dvp, dvp_dI4, &
      dvp_dI5, dphi_du, dphi_dv)
use types
implicit none
REAL(KIND=dp), intent(in) :: dI4_dBy
...
REAL(KIND=dp) function d2phi_dBy2(d2I4_dBy2, d2I5_dBy2, d2up_dI42, d2vp_dI42, &
...
REAL(KIND=dp) function d2phi_dBydBz(d2I5_dBydBz, d2up_dI42, d2vp_dI42, d2vp_dI4dI5, &
...
REAL(KIND=dp) function d2phi_dBydepsxx(d2I5_dBydeyy, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBydepsxy(d2I5_dBydexy, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBydepsyy(d2I5_dBydeyy, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBydepsyz(d2I5_dBydeyz, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBydepszx(d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, dI4_dBy, &
...
REAL(KIND=dp) function d2phi_dBydepszz(d2I5_dBydeyy, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function dphi_dBz(dI4_dBz, dI5_dBz, du_dup, dup_dI4, dv_dvp, dvp_dI4, &
      dvp_dI5, dphi_du, dphi_dv)
use types
implicit none
REAL(KIND=dp), intent(in) :: dI4_dBz
...
REAL(KIND=dp) function d2phi_dBz2(d2I4_dBz2, d2I5_dBz2, d2up_dI42, d2vp_dI42, &
...
REAL(KIND=dp) function d2phi_dBzdepsxx(d2I5_dBzdezz, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBzdepsxy(d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, dI4_dBz, &
...
REAL(KIND=dp) function d2phi_dBzdepsyy(d2I5_dBzdezz, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBzdepsyz(d2I5_dBzdeyz, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBzdepszx(d2I5_dBzdezx, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function d2phi_dBzdepszz(d2I5_dBzdezz, d2vp_dI4dI5, d2phi_dudv, d2phi_dv2, &
...
REAL(KIND=dp) function dphi_depsxx(dI5_dexx, dI5_deyy, dI5_dezz, dexx_depsxx, deyy_depsxx, &
...
REAL(KIND=dp) function d2phi_depsxx2(d2phi_dv2, dI5_dexx, dI5_deyy, dI5_dezz, dexx_depsxx, &
...
REAL(KIND=dp) function dphi_depsxy(dI5_dexy, dexy_depsxy, dv_dvp, dvp_dI5, dphi_dv)
use types
implicit none
REAL(KIND=dp), intent(in) :: dI5_dexy
REAL(KIND=dp), intent(in) :: dexy_depsxy
...
REAL(KIND=dp) function d2phi_depsxy2(d2phi_dv2, dI5_dexy, dexy_depsxy, dv_dvp, dvp_dI5)
use types
implicit none
REAL(KIND=dp), intent(in) :: d2phi_dv2
REAL(KIND=dp), intent(in) :: dI5_dexy
...
REAL(KIND=dp) function d2phi_depsxydepsyz(d2phi_dv2, dI5_dexy, dI5_deyz, dexy_depsxy, &
...
REAL(KIND=dp) function d2phi_depsxydepszx(d2phi_dv2, dI5_dexy, dI5_dezx, dexy_depsxy, &
...
REAL(KIND=dp) function dphi_depsyy(dI5_dexx, dI5_deyy, dI5_dezz, dexx_depsyy, deyy_depsyy, &
...
REAL(KIND=dp) function d2phi_depsyy2(d2phi_dv2, dI5_dexx, dI5_deyy, dI5_dezz, dexx_depsyy, &
...
REAL(KIND=dp) function dphi_depsyz(dI5_deyz, deyz_depsyz, dv_dvp, dvp_dI5, dphi_dv)
use types
implicit none
REAL(KIND=dp), intent(in) :: dI5_deyz
REAL(KIND=dp), intent(in) :: deyz_depsyz
...
REAL(KIND=dp) function d2phi_depsyz2(d2phi_dv2, dI5_deyz, deyz_depsyz, dv_dvp, dvp_dI5)
use types
implicit none
REAL(KIND=dp), intent(in) :: d2phi_dv2
REAL(KIND=dp), intent(in) :: dI5_deyz
...
REAL(KIND=dp) function d2phi_depsyzdepszx(d2phi_dv2, dI5_deyz, dI5_dezx, deyz_depsyz, &
      dezx_depszx, dv_dvp, dvp_dI5)
use types
implicit none
REAL(KIND=dp), intent(in) :: d2phi_dv2
...
REAL(KIND=dp) function dphi_depszx(dI5_dezx, dezx_depszx, dv_dvp, dvp_dI5, dphi_dv)
use types
implicit none
REAL(KIND=dp), intent(in) :: dI5_dezx
REAL(KIND=dp), intent(in) :: dezx_depszx
...
REAL(KIND=dp) function d2phi_depszx2(d2phi_dv2, dI5_dezx, dezx_depszx, dv_dvp, dvp_dI5)
use types
implicit none
REAL(KIND=dp), intent(in) :: d2phi_dv2
REAL(KIND=dp), intent(in) :: dI5_dezx
...
REAL(KIND=dp) function dphi_depszz(dI5_dexx, dI5_deyy, dI5_dezz, dexx_depszz, deyy_depszz, &
...
REAL(KIND=dp) function d2phi_depszz2(d2phi_dv2, dI5_dexx, dI5_deyy, dI5_dezz, dexx_depszz, &

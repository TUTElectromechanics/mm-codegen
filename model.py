...
Note ϕ = ϕ(u,v,w) (3-parameter model) or ϕ = ϕ(u,v) (2-parameter model).

The derivatives ∂ϕ/∂u, ∂ϕ/∂v, ∂ϕ/∂w and the function ϕ(u,v,w) must be
externally supplied; all the other partial derivatives required via the
chain rule are automatically generated by this module.
